...
| ST3  | From Admin mode build your own map | In Admin Mode         | 1. Design your own map<br />2. Key in name for the map <br />3. Click on 'save' button<br />4. Observe screen | See successful message and the map being save                                  | See successful message but map not being saved                | Fail          |
| ST4  | From Challenge Selection page to Play page | In Challenge Selection page   | 1. Select level<br />2. Press Play<br />3. Observe screen    | See play page loaded with selected level map                 |  See as expected result               | Pass          |
| ST5  | Challenge complete From Play page | In Play page                  | 1. Select correct sequence of instructions<br />2. Select Submit<br />3. Observe screen | See success message and direct to Home page                                | See as expected result                | Pass          | 
| ST6  | Challenge fail due to out of border  | In Play page | 1. Select steps that caused the car to go out of the border<br />2. Observe screen                    | See out of border message and play page reloaded with fresh instance of selected level map                               | See as expected                | Pass          |
| ST7 | Challenge fail due to wrong path                                              | In Play page                  | 1. Select steps that caused the car to reach the white panel<br />2. Observe screen                       | See wrong panel message and play page reloaded with fresh instance of selected level map |  See as expected result               | Pass          |
| ST8 | Robotic car move arrording to command send on web portal   | In Play page                  | 1. Select steps<br />2. Observe robotic car                       | See the movement of robotic car move in the direction that the user click on the web portal |  See as expected result               | Pass          |



https://user-images.githubusercontent.com/74037344/144864244-a48bcd51-7214-4c08-bd48-fd78a3c8dcc2.mp4
